...
import { defaultKeywordsForCategoryLabel } from '@/data/ebayUsRootCategories';
import type { Product } from '@/data/products';
import { fetchEbaySearchPage } from '@/lib/ebayBrowseClient';
    ...
    const run = async () => {
      ...
      try {
        const page = await fetchEbaySearchPage({
          ...
          q: defaultKeywordsForCategoryLabel(category.label),
          offset: 0,
          limit: PAGE_SIZE,
